...
# my_xml = (Path.cwd() / "group.xml")
curr_folder_path = (Path.cwd())
print("Ce swd", curr_folder_path)
print("Ce swd parent", curr_folder_path.parent)
print("Ce ideas for test", curr_folder_path.parent / 'ideas_for_test')
print("Ce ideas for test", curr_folder_path.parent / 'ideas_for_test' / 'work_with_xml' / 'groups.xml')
# print("cwd->>>", my_xml)
